  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-4">
      ...
      <p>
        ...
        mailbox against the loss of personal information. Your temporary e-mail
        address is completely anonymous. Your details: information about your
        person and users with whom you communicate, IP-address, e-mail address
        are protected and completely confidential.
      </p>
      <p>
        Tempmail-email does not store your IP-address. This means you are
        reliably protected from all unauthorised actions that may endanger your
        information and compromise your privacy. All emails and data temporarily
        stored on our service are permanently deleted after the time expired.
        You can delete your temporary Email address at any time using the
        appropriate button 'Delete' .
      </p>
      <p>
      ...
      <div className="space-y-4">
        <div className="flex flex-col gap-1">
          ...
          <p>
            Our website provides you with a temporary email address that you can
            use to receive emails and get notified of a new emails received to
            this inbox. The user may change addresses instantly (“Change”
            button) and copy it to the clipboard (“Copy” button). QR code is
            available to open the same mailbox ( email address) in another web
            browser. Please note, that Tempmail-email don’t store email messages
