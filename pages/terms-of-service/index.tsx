...
const index = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-4">
      ...
      <p>
        By using this service, you agree to the following terms. Tempmail-email
        makes no warranty of reliability or suitability for any purpose. Its
        availability or existence may be removed at any time by its owners. Any
        email sent through Tempmail-email may or may not be available for
        viewing, may be altered, and is immediately viewable by ANY user of the
        system. You agree to only access Tempmail-email data through the
        Tempmail-email website.
      </p>
      <p>
        You agree to not use Tempmail-email directly or indirectly for any
        unlawful purpose. You agree that any email you send to Tempmail-email or
        emails you induce other sites/persons to send will become public domain
        once in the Tempmail-email system with no expectation of privacy for
        email content .
      </p>
      <p>
        You agree not to use the public Tempmail-email system to receive, store,
        or view emails containing private or confidential information. You
        understand that Tempmail-email has no control over material put into
        mailboxes.
      </p>
      <p>
        ...
        innocence) from viewing emails, direct or indirect use of this system.
      </p>
      <p>
        You agree that you cannot send email using Tempmail-email, only receive.
        Moreover, the Free service handling a couple millions emails per hour.
        Therefore, you agree that emails can be stored up to 1-2 hours and the
        domains may be the subject for change. You agree, not use temporary
        emails for registering important accounts or receiving sensitive data.
        The Tempmail-email , will have no ability to restore emails or domains
        once removed.
      </p>
      <div className="space-y-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p>
            ...
            applies only to information collected through our website and not to
        ...
        <div className="flex flex-col gap-1">
          ...
          <p>
            ...
            <Link href="/privacy-policy-app">Privacy policy</Link>, we will post
