    ...
    <div className="grid grid-cols-1 md:grid-cols-12">
      ...
      <div className="col-span-1 md:col-span-6  mx-auto p-6 space-y-4">
        ...
        <p>
          ...
          Tempmail-email makes no warranty of reliability or suitability for any
          purpose. Its availability or existence may be removed at any time by
          its owners. Any email sent through Tempmail-email may or may not be
          available for viewing, may be altered, and is immediately viewable by
        ...
        <p>
          ...
          or emails you induce other sites/persons to send will become public
          domain once in the Tempmail-email system with no expectation of
          privacy for email content .
        </p>
        <p>
          You agree not to use the public Tempmail-email system to receive,
          store, or view emails containing private or confidential information.
          You understand that Tempmail-email has no control over material put
          into mailboxes.
        </p>
        <p>
        ...
        <p>
          ...
          receive. Moreover, the Free service handling a couple millions emails
          per hour. Therefore, you agree that emails can be stored up to 1-2
          hours and the domains may be the subject for change. You agree, not
          use temporary emails for registering important accounts or receiving
