      ...
      <div className="bg-white shadow-md rounded-lg p-6 max-w-3xl w-full">
        ...
        <div className="text-gray-700">
          ...
          <p className="mb-4">
            ...
            and written permission from this website’s author and/or owner is
            strictly prohibited.
          </p>
          <p className="mb-4">
            Excerpts and links may be used, provided that full and clear credit
            is given to Temp-mail with appropriate and specific direction to the
            original content.
          </p>
          <p className="mb-4">
            For permissions beyond the scope of this license, please contact us
            at{" "}
            <a href="mailto:contact@yourcompany.com" className="text-blue-500">
              contact@tempmail.com
            </a>
          </p>
        </div>
      </div>
